package test.text.ndjson;

import digigun.formats.FormatErrorCode;
import digigun.formats.text.ndjson.NdjsonCodec;
import digigun.formats.text.ndjson.NdjsonDocument;
import digigun.formats.text.ndjson.NdjsonReader;
...
class NdjsonTests {
  ...
  static function testNdjsonParsing():Void {
    ...
    var source = FixtureTools.text("text/ndjson/parse.ndjson");
  ...
  static function testNdjsonRoundTrip():Void {
    ...
    Assertions.assertEquals("ndjson serialized fixture", FixtureTools.text("text/ndjson/serialize.ndjson"), serialized);
