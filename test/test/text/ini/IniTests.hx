...
import digigun.formats.text.ini.IniValues;
...
class IniTests {
  ...
  static function testIniParsing():Void {
    var source = FixtureTools.text("text/ini/parse.ini");
  ...
  static function testIniRoundTrip():Void {
    ...
    Assertions.assertEquals("ini serialized fixture", FixtureTools.text("text/ini/serialize.ini"), serialized);
