package test.text.env;

import digigun.formats.FormatErrorCode;
import digigun.formats.text.env.EnvCodec;
import digigun.formats.text.env.EnvDocument;
import digigun.formats.text.env.EnvReader;
...
class EnvTests {
  ...
  static function testEnvParsing():Void {
    ...
    var source = FixtureTools.text("text/env/parse.env");
  ...
  static function testEnvRoundTrip():Void {
    ...
    Assertions.assertEquals("env serialized fixture", FixtureTools.text("text/env/serialize.env"), serialized);
  ...
  static function testEnvSampleFixture():Void {
    var reader = new EnvReader();
    var source = FixtureTools.text("text/env/sample.env");
