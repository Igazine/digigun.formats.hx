package test.text.yaml;

import digigun.formats.FormatErrorCode;
import digigun.formats.text.yaml.YamlArray;
import digigun.formats.text.yaml.YamlCodec;
import digigun.formats.text.yaml.YamlDocument;
import digigun.formats.text.yaml.YamlObject;
import digigun.formats.text.yaml.YamlReader;
...
class YamlTests {
  ...
  static function testYamlParsing():Void {
    ...
    var source = FixtureTools.text("text/yaml/parse.yaml");
  ...
  static function testYamlRoundTrip():Void {
    ...
    Assertions.assertEquals("yaml serialized fixture", FixtureTools.text("text/yaml/serialize.yaml"), serialized);
  ...
  static function testYamlEdgeFixture():Void {
    var reader = new YamlReader();
    var source = FixtureTools.text("text/yaml/edge.yaml");
  ...
  static function testYamlSampleFixture():Void {
    var reader = new YamlReader();
    var source = FixtureTools.text("text/yaml/sample.yaml");
