package test.editorconfig;

import digigun.formats.FormatErrorCode;
import digigun.formats.editorconfig.EditorConfigCodec;
import digigun.formats.editorconfig.EditorConfigDocument;
import digigun.formats.editorconfig.EditorConfigReader;
...
class EditorConfigTests {
  ...
  static function testEditorConfigParsing():Void {
    ...
    var source = FixtureTools.text("editorconfig/parse.editorconfig");
  ...
  static function testEditorConfigRoundTrip():Void {
    ...
    Assertions.assertEquals("editorconfig serialized fixture", FixtureTools.text("editorconfig/serialize.editorconfig"), serialized);
